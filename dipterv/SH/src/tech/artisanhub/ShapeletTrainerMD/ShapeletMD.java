...
public  class ShapeletMD implements Comparable<ShapeletMD> {
    protected DoubleVectorMD[] rawContent;
    protected DoubleVectorMD[] content;
    protected ArrayList<ArrayList<DoubleVectorMD>> contentInMergedShapelets;
    ...
    protected ShapeletMD(DoubleVectorMD[] content, int seriesId, int startPos) {
        this.content = content;
        this.seriesId = seriesId;
        this.startPos = startPos;
    }

    protected ShapeletMD(ArrayList<ArrayList<DoubleVectorMD>> content){
        this.contentInMergedShapelets = content;
    }
    // TEMPORARY - for testing
    protected ShapeletMD(DoubleVectorMD[] content, int seriesId, int startPos, double splitThreshold,
    ...
    // via csv later
    protected ShapeletMD(DoubleVectorMD[] content) {
        this.content = content;
    }
    ...
    protected void calcInfoGainAndThreshold(ArrayList<OrderLineObjMD> orderline,
    ...
    protected double calculateSeparationGap(ArrayList<OrderLineObjMD> orderline,
    ...
    // then shortness
    public int compareTo(ShapeletMD shapelet) {
        final int BEFORE = -1;
        final int EQUAL = 0;
        final int AFTER = 1;
