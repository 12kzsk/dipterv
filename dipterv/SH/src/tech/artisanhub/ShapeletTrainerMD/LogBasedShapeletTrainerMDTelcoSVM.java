...
public class LogBasedShapeletTrainerMDTelcoSVM {
	...
	public static String input_file_name;		// set by parse_command_line
	public static String model_file_name;		// set by parse_command_line
	int nr_fold;
...
//		LogProcessorMDSVM.main(args);
		...
		model_file_name = prop.getProperty("svm_model_file_name");
		input_file_name = prop.getProperty("svm_input_file_name");
