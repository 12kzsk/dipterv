...
public class ImportantShapelets {
    ...
    public ArrayList<Shapelet> GetImportantShapelets(ArrayList<Shapelet> shapelets, Instances dataSet,ArrayList<Integer> classValues) {
        ...
        Map<Integer, ShapeletBucket> shapeletBuckets = new HashMap<Integer, ShapeletBucket>(); //1 shapeletBucket <--> 1 osztályhoz tartozó shapeletek halmaza
        System.out.println();
      ...
      //osztályonként van 1-1 shap.bucket
        ...
        for (int clas : classValues) {
            ...
            Shapelet newShape = GetMinDifShape(tmp); //min. távolságú sh (az osztályhoz képest)
